...
const DestinoComponent = () => {
  ...
  const obtenerResenas = async () => {
    const resenas = await obtenerResenasDestino(2); // Pasar el ID del destino para obtener las reseñas
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      const data = await obtenerDatosDestino(2); // Pasa el ID del destino deseado
